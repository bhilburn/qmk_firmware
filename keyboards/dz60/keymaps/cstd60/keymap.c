...
/* These are here to make the CAPS_LOCK LED function correctly.
 * Reference: https://www.reddit.com/r/olkb/comments/7ur0ux/dz60_v1_caps_lock_led/dtmmem4/
*/
...
/* If the above makes the CAPS_LOCK LED function in reverse, use this instead:
void matrix_init_user(void) {
  DDRB |= (1 << 2);
  PORTB &= ~(1 << 2);
}
